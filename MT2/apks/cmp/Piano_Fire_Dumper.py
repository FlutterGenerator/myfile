...
r2 -w libMyGame.so << EOF &> /dev/null
iE > jni.txt
q
EOF
"""
...
target_patterns = {
    '_ZN8GameData13getDiamondNumEv': 'Unlimited Diamonds offset',
    '_ZN8GameData10getGlodNumEv': 'Unlimited Golds offset',
    '_ZN8GameData13getNoteNumberEv': 'Unlimited Notes offset',
    '_ZN9GameScene14deleteGameLifeEi': 'Unlimited Game Life offset'
}
