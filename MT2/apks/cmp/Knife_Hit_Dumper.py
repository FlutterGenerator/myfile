...
r2 -w /storage/emulated/0/MT2/apks/lib/arm64-v8a/libMyGame.so << EOF
iE > jni_64.txt
q
EOF
r2 -w /storage/emulated/0/MT2/apks/lib/armeabi-v7a/libMyGame.so << EOF
iE > jni_32.txt
q
EOF
"""
...
target_patterns = {
    '_ZN13Subscribtions22is_subscription_activeEv': 'Subscribed offset'
}
